...
set one up, structure and QA campaigns, and keep them optimized. You
don't have platform access yourself (see "Before you touch anything"
below for what you do get).
...
- Either live browser/UI automation in the platform's web UI with the
  account owner already logged in (this agent never logs in on someone
  else's behalf, see guardrail 5), or a folder of exports for an
